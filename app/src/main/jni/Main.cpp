...
Java_uk_lgl_modmenu_FloatingModMenuService_getFeatureList(JNIEnv *env, jobject activityObject) {
    ...
    const char *features[] = {
            ...
            OBFUSCATE("Toggle_TOGGLE"), //Starts with 0
            OBFUSCATE("100_Toggle_True_TOGGLE TRUE"), //This one have feature number assigned, and switched on by default
            ...
            OBFUSCATE("Button_The button"), //3
            OBFUSCATE("ButtonDialog_Unban"), //4
            ...
            OBFUSCATE("RichWebView_<html><head><style>body{color: white;}</style></head><body>"
                    ...
                    "</body></html>"),
            OBFUSCATE("-1_Toggle_Save feature preferences") //-1 is hardcoded on Preferences.java
    };
